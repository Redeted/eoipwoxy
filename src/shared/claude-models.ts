...
export const claudeModels: ClaudeModelMapping[] = [
  ...
  { awsId: "anthropic.claude-opus-4-5-20251101-v1:0", anthropicId: "claude-opus-4-5-20251101", displayName: "Claude 4.5 Opus" },
  { awsId: "anthropic.claude-opus-4-5-20251101-v1:0", anthropicId: "claude-opus-4-5", displayName: "Claude 4.5 Opus" },
  { awsId: "anthropic.claude-opus-4-5-20251101-v1:0", anthropicId: "claude-opus-4-5-latest", displayName: "Claude 4.5 Opus (Latest)" },
  { awsId: "anthropic.claude-opus-4-6-v1", anthropicId: "claude-opus-4-6-20260201", displayName: "Claude 4.6 Opus" },
  { awsId: "anthropic.claude-opus-4-6-v1", anthropicId: "claude-opus-4-6", displayName: "Claude 4.6 Opus" },
  { awsId: "anthropic.claude-opus-4-6-v1", anthropicId: "claude-opus-4-6-latest", displayName: "Claude 4.6 Opus (Latest)" },
  { awsId: "anthropic.claude-sonnet-4-6-v1:0", anthropicId: "claude-sonnet-4-6", displayName: "Claude 4.6 Sonnet" },
  { awsId: "anthropic.claude-sonnet-4-6-v1:0", anthropicId: "claude-sonnet-4-6-latest", displayName: "Claude 4.6 Sonnet (Latest)" },
  { awsId: "anthropic.claude-opus-4-7", anthropicId: "claude-opus-4-7", displayName: "Claude 4.7 Opus" },
  { awsId: "anthropic.claude-opus-4-7", anthropicId: "claude-opus-4-7-latest", displayName: "Claude 4.7 Opus (Latest)" },
  { awsId: "anthropic.claude-opus-4-7", anthropicId: "claude-opus-4-latest", displayName: "Claude 4 Opus (Latest)" },
  { awsId: "anthropic.claude-opus-4-8", anthropicId: "claude-opus-4-8", displayName: "Claude 4.8 Opus" },
];
